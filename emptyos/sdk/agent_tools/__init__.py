...
V1_TOOLS: list[type[Tool]] = [
    ReadTool, GrepTool, GlobTool, BashTool, PythonTool, WebSearchTool,
    WriteTool, EditTool, DeleteFunctionTool, CallAppTool,
    SkillTool, TaskListTool, FetchTool, VaultQueryTool,
    RestartDaemonTool, ScreenshotTool, SubAgentTool,
]
