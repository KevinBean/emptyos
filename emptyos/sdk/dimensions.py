...
DIMENSIONS: tuple[str, ...] = (
    ...
    "spiritual", "environmental", "financial", "occupational",
)
...
TAG_ALIASES: dict[str, tuple[str, ...]] = {
    "physical": ("body", "exercise", "workout", "zumba", "health", "fitness", "run", "ran", "running",
                 "walk", "walked", "walking", "yoga", "sleep", "slept", "gym", "swim", "swam", "hike",
                 "hiked", "bike", "biked", "stretch", "cardio", "strength", "rest", "tired", "bondi"),
    "social": ("friends", "family", "people", "church", "connect", "call", "called", "chat", "chatted",
               "dinner", "lunch", "meeting", "hangout", "party", "birthday", "mom", "dad", "brother",
               "sister", "wife", "husband", "daughter", "son", "coffee", "visit", "visited"),
    "intellectual": ("learn", "learned", "learning", "english", "study", "studied", "read", "reading",
                     "book", "lesson", "shadow", "shadowing", "article", "podcast", "course", "language",
                     "practice", "practiced", "vocabulary", "knowledge"),
    "emotional": ("feel", "felt", "feeling", "mood", "healing", "heal", "cry", "cried", "anger", "angry",
                  "grief", "sad", "happy", "anxious", "anxiety", "lonely", "love", "afraid", "overwhelmed",
                  "triggered", "insight"),
    "spiritual": ("faith", "meditate", "meditation", "meditated", "nature", "reflect", "reflected",
                  "pray", "prayed", "sabbath", "gratitude", "grateful", "quiet", "stillness", "purpose"),
    "environmental": ("home", "place", "space", "room", "clean", "cleaned", "declutter", "decluttered",
                      "organize", "organized", "house", "garden", "tidy", "moved"),
    "financial": ("money", "finance", "expense", "spent", "bought", "net", "buy", "sell", "sold", "invest",
                  "invested", "budget", "save", "saved", "income", "bank", "transfer", "bill"),
    "occupational": ("work", "job", "career", "dev", "build", "built", "code", "coded", "ship", "shipped",
                     "project", "deadline", "launch", "launched", "deploy", "deployed", "boss", "client",
                     "task", "meeting"),
}
    ...
    if source_app and manifest_map:
        ...
        if entry is not None:
            ...
            if isinstance(entry, dict):
                ...
                declared = list((app_block.get("dimensions") if isinstance(app_block, dict) else getattr(app_block, "dimensions", None)) or [])
...
def balance_score(signals: dict[str, int]) -> dict:
    ...
    if ratio is None:
        ...
        grade = "red"
    return {
        "counts": counts, "total": total, "mean": mean,
        "thin": thin, "dominant": dominant, "ratio": ratio, "grade": grade,
    }
