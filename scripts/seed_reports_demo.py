...
REQUIREMENTS = [
    {"id": "REQ-001", "text": "Cable shall carry the farm export profile (peak 180 MVA) continuously for 30 years.",
     "priority": "High",   "verification": "Analysis",      "status": "Approved"},
    {"id": "REQ-002", "text": "Cable shall withstand seabed thermal resistivity up to 1.2 K m/W at burial depth.",
     "priority": "High",   "verification": "Analysis",      "status": "Approved"},
    {"id": "REQ-003", "text": "Short-circuit rating: 40 kA for 1 second at the offshore substation busbar.",
     "priority": "High",   "verification": "Test",          "status": "Proposed"},
    {"id": "REQ-004", "text": "Burial depth shall meet the regulator minimum per soil class along the entire route.",
     "priority": "High",   "verification": "Inspection",    "status": "Approved"},
    {"id": "REQ-005", "text": "Joint bay shall provide access for in-service maintenance without a cable cut.",
     "priority": "Medium", "verification": "Demonstration", "status": "Proposed"},
    {"id": "REQ-006", "text": "Thermal derating allowance for marine growth to be finalised at CDR.",
     "priority": "Medium", "verification": "Analysis",      "status": "Proposed"},
    {"id": "REQ-007", "text": "Cable shall be type-tested to CIGRE TB 490 or equivalent.",
     "priority": "High",   "verification": "Test",          "status": "Proposed"},
    {"id": "REQ-008", "text": "Integrated fibre shall support a minimum 24 cores with OTDR baseline at commissioning.",
     "priority": "Medium", "verification": "Test",          "status": "Proposed"},
]
...
VERIFICATION = [
    {"req_id": "REQ-001", "method": "Analysis",      "evidence": "Ampacity calc report REP-ELC-0012 rev A",           "status": "Planned"},
    {"req_id": "REQ-002", "method": "Analysis",      "evidence": "Thermal model with soil-resistivity sensitivity",    "status": "Planned"},
    {"req_id": "REQ-003", "method": "Test",          "evidence": "Type-test short-circuit certificate (CIGRE TB 490)", "status": "Planned"},
    {"req_id": "REQ-004", "method": "Inspection",    "evidence": "Post-lay survey report and as-built burial-depth map","status": "Planned"},
    {"req_id": "REQ-005", "method": "Demonstration", "evidence": "Joint bay access mock-up; FAT walkthrough",          "status": "Planned"},
    {"req_id": "REQ-006", "method": "Analysis",      "evidence": "Biofouling survey and updated thermal model at CDR", "status": "Planned"},
    {"req_id": "REQ-007", "method": "Test",          "evidence": "Type-test certificate from accredited lab",          "status": "Planned"},
    {"req_id": "REQ-008", "method": "Test",          "evidence": "OTDR baseline trace at commissioning",               "status": "Planned"},
]
...
def main() -> int:
    created = req("POST", "/reports/api/reports", {
        "template": "pdr",
    ...
    for name, rows in (("requirements", REQUIREMENTS), ("risks", RISKS), ("verification", VERIFICATION)):
