...
PRESETS = {
    "project-tracker": {
        ...
        "columns": [
            ...
            {"id": "status", "label": "Status", "type": "select",
             ...
             "color_map": {"idea": "gray", "active": "green", "blocked": "red",
                           "shelved": "amber", "completed": "purple"}},
            ...
            {"id": "deliverables", "label": "Deliverables", "type": "link-record",
             "target_board": "engineering-deliverables", "multi": True,
             "inverse": "parent_project"},
            {"id": "deliverable_count", "label": "#", "type": "formula",
             "expression": "COUNT(deliverables)"},
            {"id": "total_est_hours", "label": "Hrs", "type": "formula",
             "expression": "SUM(deliverables.est_hours)", "suffix": "h"},
            {"id": "avg_deliverable_progress", "label": "Delivery %", "type": "formula",
             "expression": "ROUND(AVG(deliverables.progress) * 100, 0)", "suffix": "%"},
            {"id": "at_risk", "label": "At risk", "type": "formula",
    ...
    "crm-pipeline": {
        ...
        "columns": [
            ...
            {"id": "status", "label": "Stage", "type": "select",
             "options": ["New", "Contacted", "Proposal", "Won", "Lost"],
             "color_map": {"New": "blue", "Contacted": "amber", "Proposal": "purple",
                           "Won": "green", "Lost": "red"}},
    ...
    "bug-tracker": {
        ...
        "columns": [
            ...
            {"id": "severity", "label": "Severity", "type": "select",
             "options": ["Low", "Medium", "High", "Critical"],
             "color_map": {"Low": "gray", "Medium": "amber", "High": "orange", "Critical": "red"}},
            {"id": "status", "label": "Status", "type": "select",
             "options": ["Open", "In Progress", "Fixed", "Closed", "Won't Fix"],
             "color_map": {"Open": "red", "In Progress": "amber", "Fixed": "green",
                           "Closed": "gray", "Won't Fix": "gray"}},
    ...
    "content-calendar": {
        ...
        "columns": [
            ...
            {"id": "status", "label": "Status", "type": "select",
             ...
             "color_map": {"Idea": "blue", "Drafting": "amber", "Review": "purple",
                           "Scheduled": "emerald", "Published": "green"}},
    ...
    "sprint-board": {
        ...
        "columns": [
            ...
            {"id": "status", "label": "Status", "type": "select",
             ...
             "color_map": {"Backlog": "gray", "To Do": "blue", "In Progress": "amber",
                           "In Review": "purple", "Done": "green"}},
            {"id": "assignee", "label": "Assignee", "type": "text"},
    ...
    "engineering-deliverables": {
        ...
        "columns": [
            ...
            {"id": "parent_project", "label": "Project", "type": "link-record",
             "target_board": "project-tracker", "multi": False,
             "inverse": "deliverables"},
            # Per-item formula: overdue only counts if the drawing isn't IFC yet.
            {"id": "overdue", "label": "Late?", "type": "formula",
...
PRESETS["job-applications"] = {
    ...
    "columns": [
        ...
        {"id": "status", "label": "Status", "type": "select",
         "options": ["shortlisted", "recruiter_contact", "applied", "phone_screen",
                     "interview", "offer", "accepted", "rejected", "withdrawn", "not_pursuing"],
         "color_map": {"shortlisted": "blue", "recruiter_contact": "purple",
                       "applied": "amber", "phone_screen": "amber",
                       "interview": "orange", "offer": "emerald",
                       "accepted": "green", "rejected": "red",
                       "withdrawn": "gray", "not_pursuing": "gray"}},
        {"id": "priority", "label": "Priority", "type": "select",
...
PRESETS["reminders"] = {
    ...
    "columns": [
        ...
        {"id": "repeat", "label": "Repeat", "type": "select",
         "options": ["", "daily", "weekly", "monthly"]},
    ],
    "views": [
        {"type": "kanban", "group_by": "status", "default": True},
...
PRESETS["media-library"] = {
    ...
    "columns": [
        ...
        {"id": "status", "label": "Status", "type": "select",
         ...
         "color_map": {"wishlist": "gray", "reading": "amber", "watching": "amber",
...
PRESETS["expense-log"] = {
    ...
    "columns": [
        ...
        {"id": "category", "label": "Category", "type": "select",
         "options": ["Dining", "Groceries", "Transport", "Shopping", "Bills",
                     "Health", "Entertainment", "Recurring", "Other"],
         "color_map": {"Dining": "amber", "Groceries": "green", "Transport": "blue",
                       "Shopping": "purple", "Bills": "red", "Health": "emerald",
                       "Entertainment": "orange", "Recurring": "gray", "Other": "gray"}},
        {"id": "source", "label": "Source", "type": "text"},
    ],
    "views": [
        {"type": "table", "default": True},
...
PRESETS["people-roster"] = {
    ...
    "columns": [
        ...
        {"id": "relationship", "label": "Relationship", "type": "select",
         "options": ["", "family", "friend", "partner", "colleague", "mentor",
                     "mentee", "client", "acquaintance"],
         "color_map": {"family": "red", "friend": "amber", "partner": "purple",
                       "colleague": "blue", "mentor": "emerald", "mentee": "green",
                       "client": "orange", "acquaintance": "gray"}},
        {"id": "energy", "label": "Energy", "type": "select",
         "options": ["", "gives", "neutral", "drains"],
         "color_map": {"gives": "green", "neutral": "gray", "drains": "red"}},
        {"id": "trust_level", "label": "Trust", "type": "number"},
        {"id": "band", "label": "Capacity", "type": "select",
        ...
        {"id": "contact_frequency", "label": "Frequency", "type": "select",
...
PRESETS["task-tracker"] = {
    ...
    "columns": [
        ...
        {"id": "due", "label": "Due", "type": "date"},
        {"id": "tier", "label": "Age", "type": "select",
         "options": ["fresh", "aging", "stale", "zombie"],
         "color_map": {"fresh": "green", "aging": "amber",
                       "stale": "red", "zombie": "gray"}},
...
PRESETS["places"] = {
    ...
    "columns": [
        {"id": "name", "label": "Name", "type": "text"},
        {"id": "category", "label": "Category", "type": "select",
         "options": ["", "restaurant", "cafe", "bar", "park", "museum",
                     "shop", "landmark", "lodging", "other"],
         "color_map": {"restaurant": "amber", "cafe": "orange", "bar": "purple",
                       "park": "green", "museum": "blue", "shop": "gray",
                       "landmark": "emerald", "lodging": "red", "other": "gray"}},
        {"id": "rating", "label": "Rating", "type": "number", "suffix": "/5"},
