...
TEMPLATES: dict[str, dict] = {
        ...
        "sections": [
            {
                ...
                "prompt_hint": "One paragraph: what is being designed, why now, what this review covers.",
            },
            {
                "slug": "scope",
    ...
    "trr": {
        ...
        "sections": [
            ...
            {
                "slug": "uut",
                "title": "2. Unit Under Test Configuration",
            ...
            {
                "slug": "requirements-covered",
                "title": "4. Requirements Coverage",
                "render": "table:verification",
            ...
            {"slug": "risks", "title": "7. Residual Risks", "render": "table:risks"},
    ...
    "spec": {
        ...
        "sections": [
            ...
            {"slug": "verification", "title": "6. Verification", "render": "table:verification"},
    ...
    "requirements": {
        "columns": [
            ...
            },
            {
                ...
                "label": "Verification",
                "width": "short",
                "options": ["Analysis", "Test", "Inspection", "Demonstration"],
            },
            {
                "key": "status",
                "label": "Status",
                "width": "short",
                "options": ["Proposed", "Approved", "Verified", "Closed"],
            },
        ],
        "id_prefix": "REQ",
    },
    ...
    "verification": {
        "columns": [
            ...
            {"key": "evidence", "label": "Evidence / Ref", "width": "wide"},
            {
                ...
                "label": "Status",
                "width": "short",
                "options": ["Planned", "In Progress", "Passed", "Failed", "Waived"],
            },
        ],
        "id_prefix": "",
    },
